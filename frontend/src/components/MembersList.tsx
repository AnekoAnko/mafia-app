...
const PlayerList = ({
  ...
  return (
    <div className="relative w-1/4 bg-gray-200 p-4 border-r overflow-y-auto">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center space-x-2">
                  ...
                  {isMe && <span className="text-xs text-indigo-600">Ви</span>}
                  {!started && isHost && player.id === players[0].id && (
                    <span className="text-xs text-green-600">Власник</span>
                  )}
                </div>
